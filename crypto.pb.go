...
var file_crypto_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
var file_crypto_proto_goTypes = []any{
	...
	(*FinalizeRequest)(nil),                 // 3: icrypto.FinalizeRequest
	(*FinalizeResponse)(nil),                // 4: icrypto.FinalizeResponse
	(*ActivationDRMHandshakeRequest)(nil),   // 5: icrypto.ActivationDRMHandshakeRequest
	(*ActivationDRMHandshakeResponse)(nil),  // 6: icrypto.ActivationDRMHandshakeResponse
	(*ActivationDRMProcessRequest)(nil),     // 7: icrypto.ActivationDRMProcessRequest
	(*ActivationDRMProcessResponse)(nil),    // 8: icrypto.ActivationDRMProcessResponse
	(*ActivationDRMSignatureRequest)(nil),   // 9: icrypto.ActivationDRMSignatureRequest
	(*ActivationDRMSignatureResponse)(nil),  // 10: icrypto.ActivationDRMSignatureResponse
	(*ActivationDeprecatedRequest)(nil),     // 11: icrypto.ActivationDeprecatedRequest
	(*ActivationDeprecatedResponse)(nil),    // 12: icrypto.ActivationDeprecatedResponse
	(*ActivationRecordRequest)(nil),         // 13: icrypto.ActivationRecordRequest
	(*ActivationRecordResponse)(nil),        // 14: icrypto.ActivationRecordResponse
	(*ADIStartProvisioningRequest)(nil),     // 15: icrypto.ADIStartProvisioningRequest
	(*ADIStartProvisioningResponse)(nil),    // 16: icrypto.ADIStartProvisioningResponse
	(*ADIEndProvisioningRequest)(nil),       // 17: icrypto.ADIEndProvisioningRequest
	(*ADIEndProvisioningResponse)(nil),      // 18: icrypto.ADIEndProvisioningResponse
	(*ADIGenerateLoginCodeRequest)(nil),     // 19: icrypto.ADIGenerateLoginCodeRequest
	(*ADIGenerateLoginCodeResponse)(nil),    // 20: icrypto.ADIGenerateLoginCodeResponse
	(*AbsintheHelloRequest)(nil),            // 21: icrypto.AbsintheHelloRequest
	(*AbsintheHelloResponse)(nil),           // 22: icrypto.AbsintheHelloResponse
	(*AbsintheAddOptionRequest)(nil),        // 23: icrypto.AbsintheAddOptionRequest
	(*AbsintheAddOptionResponse)(nil),       // 24: icrypto.AbsintheAddOptionResponse
	(*AbsintheActivateSessionRequest)(nil),  // 25: icrypto.AbsintheActivateSessionRequest
	(*AbsintheActivateSessionResponse)(nil), // 26: icrypto.AbsintheActivateSessionResponse
	(*AbsintheSignDataRequest)(nil),         // 27: icrypto.AbsintheSignDataRequest
	(*AbsintheSignDataResponse)(nil),        // 28: icrypto.AbsintheSignDataResponse
	(*IdentitySessionRequest)(nil),          // 29: icrypto.IdentitySessionRequest
	(*IdentitySessionResponse)(nil),         // 30: icrypto.IdentitySessionResponse
	(*IdentityValidationRequest)(nil),       // 31: icrypto.IdentityValidationRequest
	(*IdentityValidationResponse)(nil),      // 32: icrypto.IdentityValidationResponse
	(*SAPExchangeRequest)(nil),              // 33: icrypto.SAPExchangeRequest
	(*SAPExchangeResponse)(nil),             // 34: icrypto.SAPExchangeResponse
	(*SAPSignPrimeRequest)(nil),             // 35: icrypto.SAPSignPrimeRequest
	(*SAPSignPrimeResponse)(nil),            // 36: icrypto.SAPSignPrimeResponse
	(*SAPVerifyPrimeRequest)(nil),           // 37: icrypto.SAPVerifyPrimeRequest
	(*SAPVerifyPrimeResponse)(nil),          // 38: icrypto.SAPVerifyPrimeResponse
	(*SAPSignRequest)(nil),                  // 39: icrypto.SAPSignRequest
	(*SAPSignResponse)(nil),                 // 40: icrypto.SAPSignResponse
	(*SAPVerifyRequest)(nil),                // 41: icrypto.SAPVerifyRequest
	(*SAPVerifyResponse)(nil),               // 42: icrypto.SAPVerifyResponse
}
var file_crypto_proto_depIdxs = []int32{
	...
	3,  // 2: icrypto.CryptService.Finalize:input_type -> icrypto.FinalizeRequest
	5,  // 3: icrypto.CryptService.ActivationDRMHandshake:input_type -> icrypto.ActivationDRMHandshakeRequest
	7,  // 4: icrypto.CryptService.ActivationDRMProcess:input_type -> icrypto.ActivationDRMProcessRequest
	9,  // 5: icrypto.CryptService.ActivationDRMSignature:input_type -> icrypto.ActivationDRMSignatureRequest
	11, // 6: icrypto.CryptService.ActivationDeprecated:input_type -> icrypto.ActivationDeprecatedRequest
	13, // 7: icrypto.CryptService.ActivationRecord:input_type -> icrypto.ActivationRecordRequest
	15, // 8: icrypto.CryptService.ADIStartProvisioning:input_type -> icrypto.ADIStartProvisioningRequest
	17, // 9: icrypto.CryptService.ADIEndProvisioning:input_type -> icrypto.ADIEndProvisioningRequest
	19, // 10: icrypto.CryptService.ADIGenerateLoginCode:input_type -> icrypto.ADIGenerateLoginCodeRequest
	21, // 11: icrypto.CryptService.AbsintheHello:input_type -> icrypto.AbsintheHelloRequest
	23, // 12: icrypto.CryptService.AbsintheAddOption:input_type -> icrypto.AbsintheAddOptionRequest
	25, // 13: icrypto.CryptService.AbsintheActivateSession:input_type -> icrypto.AbsintheActivateSessionRequest
	27, // 14: icrypto.CryptService.AbsintheSignData:input_type -> icrypto.AbsintheSignDataRequest
	29, // 15: icrypto.CryptService.IdentitySession:input_type -> icrypto.IdentitySessionRequest
	31, // 16: icrypto.CryptService.IdentityValidation:input_type -> icrypto.IdentityValidationRequest
	33, // 17: icrypto.CryptService.SAPExchange:input_type -> icrypto.SAPExchangeRequest
	35, // 18: icrypto.CryptService.SAPSignPrime:input_type -> icrypto.SAPSignPrimeRequest
	37, // 19: icrypto.CryptService.SAPVerifyPrime:input_type -> icrypto.SAPVerifyPrimeRequest
	39, // 20: icrypto.CryptService.SAPSign:input_type -> icrypto.SAPSignRequest
	41, // 21: icrypto.CryptService.SAPVerify:input_type -> icrypto.SAPVerifyRequest
	2,  // 22: icrypto.CryptService.Initialize:output_type -> icrypto.InitializeResponse
	4,  // 23: icrypto.CryptService.Finalize:output_type -> icrypto.FinalizeResponse
	6,  // 24: icrypto.CryptService.ActivationDRMHandshake:output_type -> icrypto.ActivationDRMHandshakeResponse
	8,  // 25: icrypto.CryptService.ActivationDRMProcess:output_type -> icrypto.ActivationDRMProcessResponse
	10, // 26: icrypto.CryptService.ActivationDRMSignature:output_type -> icrypto.ActivationDRMSignatureResponse
	12, // 27: icrypto.CryptService.ActivationDeprecated:output_type -> icrypto.ActivationDeprecatedResponse
	14, // 28: icrypto.CryptService.ActivationRecord:output_type -> icrypto.ActivationRecordResponse
	16, // 29: icrypto.CryptService.ADIStartProvisioning:output_type -> icrypto.ADIStartProvisioningResponse
	18, // 30: icrypto.CryptService.ADIEndProvisioning:output_type -> icrypto.ADIEndProvisioningResponse
	20, // 31: icrypto.CryptService.ADIGenerateLoginCode:output_type -> icrypto.ADIGenerateLoginCodeResponse
	22, // 32: icrypto.CryptService.AbsintheHello:output_type -> icrypto.AbsintheHelloResponse
	24, // 33: icrypto.CryptService.AbsintheAddOption:output_type -> icrypto.AbsintheAddOptionResponse
	26, // 34: icrypto.CryptService.AbsintheActivateSession:output_type -> icrypto.AbsintheActivateSessionResponse
	28, // 35: icrypto.CryptService.AbsintheSignData:output_type -> icrypto.AbsintheSignDataResponse
	30, // 36: icrypto.CryptService.IdentitySession:output_type -> icrypto.IdentitySessionResponse
	32, // 37: icrypto.CryptService.IdentityValidation:output_type -> icrypto.IdentityValidationResponse
	34, // 38: icrypto.CryptService.SAPExchange:output_type -> icrypto.SAPExchangeResponse
	36, // 39: icrypto.CryptService.SAPSignPrime:output_type -> icrypto.SAPSignPrimeResponse
	38, // 40: icrypto.CryptService.SAPVerifyPrime:output_type -> icrypto.SAPVerifyPrimeResponse
	40, // 41: icrypto.CryptService.SAPSign:output_type -> icrypto.SAPSignResponse
	42, // 42: icrypto.CryptService.SAPVerify:output_type -> icrypto.SAPVerifyResponse
