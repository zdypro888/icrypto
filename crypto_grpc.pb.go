...
type CryptServiceClient interface {
	...
	ActivationDRMGenerate(ctx context.Context, in *ActivationDRMGenerateRequest, opts ...grpc.CallOption) (*ActivationDRMGenerateResponse, error)
	ActivationDRMResponse(ctx context.Context, in *ActivationDRMResponseRequest, opts ...grpc.CallOption) (*ActivationDRMResponseResponse, error)
	ActivationDRMSignData(ctx context.Context, in *ActivationDRMSignDataRequest, opts ...grpc.CallOption) (*ActivationDRMSignDataResponse, error)
...
func (c *cryptServiceClient) ActivationDRMGenerate(ctx context.Context, in *ActivationDRMGenerateRequest, opts ...grpc.CallOption) (*ActivationDRMGenerateResponse, error) {
	out := new(ActivationDRMGenerateResponse)
	err := c.cc.Invoke(ctx, "/icrypto.CryptService/ActivationDRMGenerate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cryptServiceClient) ActivationDRMResponse(ctx context.Context, in *ActivationDRMResponseRequest, opts ...grpc.CallOption) (*ActivationDRMResponseResponse, error) {
	out := new(ActivationDRMResponseResponse)
	err := c.cc.Invoke(ctx, "/icrypto.CryptService/ActivationDRMResponse", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cryptServiceClient) ActivationDRMSignData(ctx context.Context, in *ActivationDRMSignDataRequest, opts ...grpc.CallOption) (*ActivationDRMSignDataResponse, error) {
	out := new(ActivationDRMSignDataResponse)
	err := c.cc.Invoke(ctx, "/icrypto.CryptService/ActivationDRMSignData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CryptServiceServer interface {
	...
	ActivationDRMGenerate(context.Context, *ActivationDRMGenerateRequest) (*ActivationDRMGenerateResponse, error)
	ActivationDRMResponse(context.Context, *ActivationDRMResponseRequest) (*ActivationDRMResponseResponse, error)
	ActivationDRMSignData(context.Context, *ActivationDRMSignDataRequest) (*ActivationDRMSignDataResponse, error)
...
func (UnimplementedCryptServiceServer) ActivationDRMGenerate(context.Context, *ActivationDRMGenerateRequest) (*ActivationDRMGenerateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ActivationDRMGenerate not implemented")
}
func (UnimplementedCryptServiceServer) ActivationDRMResponse(context.Context, *ActivationDRMResponseRequest) (*ActivationDRMResponseResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ActivationDRMResponse not implemented")
}
func (UnimplementedCryptServiceServer) ActivationDRMSignData(context.Context, *ActivationDRMSignDataRequest) (*ActivationDRMSignDataResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ActivationDRMSignData not implemented")
}
...
func _CryptService_ActivationDRMGenerate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(CryptServiceServer).ActivationDRMGenerate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
func _CryptService_ActivationDRMResponse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(CryptServiceServer).ActivationDRMResponse(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
func _CryptService_ActivationDRMSignData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(CryptServiceServer).ActivationDRMSignData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var CryptService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ActivationDRMGenerate",
			Handler:    _CryptService_ActivationDRMGenerate_Handler,
		},
		{
			MethodName: "ActivationDRMResponse",
			Handler:    _CryptService_ActivationDRMResponse_Handler,
		},
		{
			MethodName: "ActivationDRMSignData",
			Handler:    _CryptService_ActivationDRMSignData_Handler,
		},
		{
