...
type CryptServiceClient interface {
	...
	SyncDevice(ctx context.Context, in *SyncDeviceRequest, opts ...grpc.CallOption) (*SyncDeviceResponse, error)
	// 结束
...
func (c *cryptServiceClient) SyncDevice(ctx context.Context, in *SyncDeviceRequest, opts ...grpc.CallOption) (*SyncDeviceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SyncDeviceResponse)
	err := c.cc.Invoke(ctx, CryptService_SyncDevice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CryptServiceServer interface {
	...
	// 同步设备状态，但不重新初始化 cryptor
	SyncDevice(context.Context, *SyncDeviceRequest) (*SyncDeviceResponse, error)
	// 结束
...
func (UnimplementedCryptServiceServer) SyncDevice(context.Context, *SyncDeviceRequest) (*SyncDeviceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SyncDevice not implemented")
}
...
func _CryptService_SyncDevice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SyncDeviceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CryptServiceServer).SyncDevice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CryptService_SyncDevice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CryptServiceServer).SyncDevice(ctx, req.(*SyncDeviceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CryptService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CryptService_SyncDevice_Handler,
		},
		{
			MethodName: "Finalize",
